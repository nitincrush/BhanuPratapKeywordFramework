...
//	public static Properties AppText = new Properties();
	...
	public static void Initialize() throws IOException {
		...
		TestStepData = new Xls_Reader(System.getProperty("user.dir")+"//src//main//java//com//companyname//projectname//Data//TestSuite1Data.xlsx");
		SuiteData = new Xls_Reader(System.getProperty("user.dir")+"//src//main//java//com//companyname//projectname//Data//TestSuite1.xlsx");
		System.out.println(System.getProperty("user.dir"));
		
		f = new File(System.getProperty("user.dir")+"//src//main//java//com//companyname//projectname//repository//login.properties");
