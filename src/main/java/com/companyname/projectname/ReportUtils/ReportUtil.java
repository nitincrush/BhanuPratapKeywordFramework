...
public class ReportUtil 
{
	...
	public static void startTesting(String filename, String testStartTime, String env, String releaseNum) {
		...
		try {
			...
			String RELEASE = releaseNum;// SeleniumServerTest.ConfigurationMap.getProperty("release");
